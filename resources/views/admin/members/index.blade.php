    ...
    <div class="white-box">
        <div class="table-responsive">
            <table class="table member-overview" id="myTable">
                ...
                <tr>
                    <td>{{ $key+1 }}</td>
                    <td>{{ $member->employee->store->name }}</td>
                    ...
                    <td>
                        <a href="{{ route('admin.members.edit', $member->id)  }}" class="text-inverse p-r-10" data-toggle="tooltip" title="Edit"><i class="ti-marker-alt"></i></a>
