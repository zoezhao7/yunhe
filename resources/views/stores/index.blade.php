                    ...
                    <table class="table table-condensed table-striped">
                        <thead>
                            <tr>
                                ...
                                <th>Name</th> <th>Phone</th> <th>Address</th> <th>Employees_count</th> <th>Is_open</th>
                        ...
                        <tbody>
                            @foreach($stores as $store)
                                <tr>
                                    ...
                                    <td>{{$store->name}}</td> <td>{{$store->phone}}</td> <td>{{$store->address}}</td> <td>{{$store->employees_count}}</td> <td>{{$store->is_open}}</td>
