...
class SpecsTableSeeder extends Seeder
{
    public function run()
    {
        ...
        $contents = [
            ...
            ['工艺'=>'', 'ET'=>'71', 'CB'=>'71.6', 'PCD'=>'5*130', 'CAP'=>'捷豹盖','PCD钻头'=>'15*32*60','螺丝'=>'M12*1.5'],
            ['工艺'=>'', 'ET'=>'69', 'CB'=>'60.1', 'PCD'=>'5*114.3', 'CAP'=>'宝马盖','PCD钻头'=>'m14*1.5','螺丝'=>'M14*1.5'],
            ['工艺'=>'', 'ET'=>'38', 'CB'=>'67.1', 'PCD'=>'5*108', 'CAP'=>'宝马盖','PCD钻头'=>'m12*1.5','螺丝'=>'M14*1.5'],
            ['工艺'=>'半哑光黑', 'ET'=>'45', 'CB'=>'70.6', 'PCD'=>'5*120', 'CAP'=>'','PCD钻头'=>'15*32*SR13','螺丝'=>''],
            ['工艺'=>'', 'ET'=>'50', 'CB'=>'66.5', 'PCD'=>'5*108', 'CAP'=>'','PCD钻头'=>'','螺丝'=>''],
            ['工艺'=>'', 'ET'=>'35', 'CB'=>'63.4', 'PCD'=>'5*112', 'CAP'=>'','PCD钻头'=>'','螺丝'=>''],
        ];
        ...
        $specs = factory(Spec::class)
            ...
            ->each(function ($spec, $index) use ($faker, $product_ids, $sizes, $contents) {
                ...
                $spec->number = 'UC' . rand(111111, 999999);
